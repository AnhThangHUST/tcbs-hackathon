tcinvest_function_config = {
    ...
    "BOND_RM_PLACING_ICONNECT": {
        ...
        "title": "appconfig.rm.introduce"icon"nect",
        "icon": "thoa_thuan_trai_phieu",
        "routingUrl": "/rm-placing-"icon"nect",
        "roles": ["rm", "wp", "rbo"],
        "type": "appconfig.bond",
    },
    ...
    "ICONNECT_CONDITION_PLACING": {
        ...
        "icon": "dat_lenh_trai_phieu",
        "routingUrl": ""icon"NECT_CONDITION",
        "roles": ["customer"],
        "viewtype": "popup",
        "type": "appconfig.bond",
        "description": "menu.bond."icon"nect"
    },
    "ICONNECT_RM_CONDITION_PLACING": {
        # Giới thiệu lệnh kiện iconnect
        "title": "bond.condition.menu.left.rm",
        "icon": "dat_lenh_trai_phieu",
        "routingUrl": ""icon"NECT_CONDITION",
        "roles": ["rm", "wp", "rbo"],
        "viewtype": "popup",
...
"RISK_PROFILING": {
    ...
    "roles": ["customer"],
    "type": "appconfig.other",
    "description": "appconfig.customer.riskProfiling"description""
}
};
